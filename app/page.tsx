        ...
        <div className="max-w-7xl mx-auto section-padding">
          ...
          {isMenuOpen && (
            <div className="md:hidden py-4 space-y-4 bg-dark-900/95 backdrop-blur-lg rounded-lg mt-2">
              <button
                onClick={() => scrollToSection("about")}
                className="block w-full text-left px-4 py-2 hover:text-primary-400 transition-colors"
              >
                About
              </button>
              <button
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="glass-card p-8 text-center group hover:bg-white/10 transition-all duration-300">
              ...
              <p className="text-gray-300">
                Personalized one-on-one yoga instruction tailored to your
            ...
            <div className="glass-card p-8 text-center group hover:bg-white/10 transition-all duration-300">
              ...
              <p className="text-gray-300">
                Join our welcoming community in group yoga and wellness sessions
                for all levels.
              </p>
            </div>
            ...
            <div className="glass-card p-8 text-center group hover:bg-white/10 transition-all duration-300">
              ...
              <p className="text-gray-300">
                Holistic wellness guidance covering nutrition, mindfulness, and
                lifestyle balance.
              </p>
            </div>
            ...
            <div className="glass-card p-8 text-center group hover:bg-white/10 transition-all duration-300">
              ...
              <p className="text-gray-300">
                Learn powerful meditation techniques to cultivate inner peace
                and mental clarity.
              </p>
            </div>
          </div>
            ...
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <div>
                    <div className="font-semibold text-primary-400 group-hover:text-primary-300">
                      Read My Articles
                    </div>
      ...
      <footer className="py-8 section-padding border-t border-white/10">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-gray-400 mb-2">
            &copy; 2024 Eyimofe. All rights reserved.
          </p>
